...
<br/>
<span>
컴포넌트의 상단에서 아래와 같이 state 변수와 해당 state 변수를 갱신하는 함수를 반환하는 useState를 호출합니다.
</span>
...
<br/>
<span>
또한 특정 값이 업데이트될때마다 useEffect가 실행되기 원한다면 원하는 값이 추가된 배열을 넣어주면 됩니다.
...
<br/>
<span>
이번 게시글에선 React Hook의 도입 동기와 가장 중요한 Hook인 useState와 useEffect에 대해 알아봤습니다. 다음 Hook 2편에서는 더 다양한 Hook의 종류와 사용자 정의 Hook에 대해 알아보겠습니다!
</span>
